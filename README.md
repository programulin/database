...
Подключаем скрипт, создаём объект Database и передаём в него реквизиты доступа. При необходимости можно указать максимальное время ожидания и кодировку (по-умолчанию UTF8).
